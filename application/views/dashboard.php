                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">Rp. <?= $brg->harga?>
                                                <?php echo anchor('dashboard/keranjang/'.$brg->id, '<button class="btn btn-info btn-user" type="button">
                                                   <i class="fas fa-dollar-sign fa-1x text-primary-300"></i>
                                                </button>') ?> 
                                                <?php echo anchor('dashboard/detail/'.$brg->id, '<button class="btn btn-info btn-user" type="button">
